...
<body>
	...
	<%
		...
		// project web.xml 에 설정된 session 유지 시간 : 600s - 10분
		
		// 해당 session 만 유지 시간을 60s로 지정
		// session.setMaxInactiveInterval(60);
		
		// 해당 session 객체의 최대 유지 시간 - 초 단위
		...
		// session 객체가 생성된 시간을 millis로 변환
		...
		out.println("전체 session 마지막 요청 시간 : " + time + "<br/>");
		
		String uid = (String)session.getAttribute("uid");
		out.println("session 속성에 저장된 id : " + uid + "<br/>");
